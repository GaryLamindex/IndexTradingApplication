...
start_date = dt.datetime(2004, 1, 1)  # YYMMDD
end_date = dt.datetime(2005, 12, 2)  # YYMMDD
...
rabalance_dict = {"start":50, "end":100, "step":10}
maintain_dict = {"start":50, "end":100, "step":10}
...
data_freq = "one_min"
user_id = 0
rebalance_margin_wif_max_drawdown_control_backtest = rebalance_margin_wif_max_drawdown_control_backtest(tickers, initial_amount, start_date, end_date, cal_stat, rabalance_dict, maintain_dict, max_drawdown_ratio_dict, purchase_exliq_ratio_dict, data_freq, user_id, db_mode, quick_test)
