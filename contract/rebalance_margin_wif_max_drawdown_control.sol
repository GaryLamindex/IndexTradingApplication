...
contract algorithm is Object, StockTrading{
    ...
    mapping (string => uint256) benchmarkDrawdownPrice;
    mapping (string => uint256) liquidateTickerQty;
    mapping (string => uint256) maxStockPrice;
    mapping (string => uint256) liqSoldQty;
    mapping (string => uint256) liqSoldPrice;
    uint256 loop = 0;
...
//        return ticker_price > range_price
        uint256 rangePrice = benchmarkDrawdownPrice[ticker] * (100 + 1);
        uint256 comparisonPrice = realTimeTickerPrice * 100;
